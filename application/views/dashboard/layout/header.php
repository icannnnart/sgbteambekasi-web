...
<html lang="en">
   <head>
      ...
      <script src="<?=base_url('assets/dashboard')?>/vendors/chart.js/chart.umd.js"></script>
       ...
       <link rel="stylesheet" href="<?=base_url('assets/dashboard')?>/vendors/jam/jam.css">
   </head>
   <body>
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
               ...
               <ul class="navbar-nav navbar-nav-right">
                  ...
                  <li class="nav-item nav-settings text-center">
                        ...
                        <br>
                        <p><?php $roles = $this->M_db->Get_user_by_id('t_level_akun','id',$user->status); print_r($roles->name);?></p>
                     </h6>
