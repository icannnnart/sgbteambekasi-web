                   ...
                   <div class="card-body">
                     <div class="d-flex flex-row align-items-center">
                       ...
                       <div class="ms-3">
                         ...
                         <p class="fs-30 mb-2 text-white"><span style="font-size: 1.3rem;"><?php $topname = $this->M_db->Get_user_by_id('t_user','id',$topspend->id_user); print_r($topname->name);?>  <span style="font-size:30px">[ </span>IDR </span><?=number_format($topspend->total_spend)?> ]</p>
                       </div>
                     </div>
                   </div>
                 </div>
