                   ...
                   <div class="card-body">
                     <div class="d-flex flex-row align-items-center">
                       ...
                       <div class="ms-3">
                         ...
                         <p class="fs-30 mb-2 text-white"><span style="font-size: 1rem;"><?php $topname = $this->M_db->Get_user_by_id('t_user','id',$topspend->id_user); print_r($topname->name);?></span><span style="font-size: 12px;">IDR </span><?=number_format($topspend->nominal)?></p>
                       </div>
                     </div>
                   </div>
                 </div>
